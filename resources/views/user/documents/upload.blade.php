...
<div class="mb-6">
    ...
    <p class="text-gray-600 mt-1">Submit required documents for your loan application.</p>
</div>
    ...
    <form action="{{ route('user.documents.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
        ...
        <div>
            ...
            <div class="border-2 border-dashed border-gray-300 rounded-lg p-8 text-center hover:bg-gray-50 transition cursor-pointer relative">
                ...
                <p class="text-sm text-gray-600 font-medium">Click to browse or drag file here</p>
