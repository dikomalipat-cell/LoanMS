...
<div class="mb-6">
    ...
    <p class="text-slate-300 mt-1">Monitor and verify incoming borrower payments.</p>
</div>
        ...
        <table class="w-full text-left border-collapse">
            ...
            <tbody>
                ...
                <tr class="border-b border-gray-50 hover:bg-primary-dark transition">
                    ...
                    <td class="p-4 text-sm font-medium text-white">₱ {{ number_format($payment->amount, 2) }}</td>
                    ...
                    <td class="p-4 text-right">
                        <button class="text-green-500 hover:text-gold mr-2" title="Verify"><i class="fas fa-check-circle"></i></button>
                        <button class="text-red-500 hover:text-red-700" title="Reject"><i class="fas fa-times-circle"></i></button>
                    </td>
                </tr>
                @empty
                <tr>
                    <td colspan="6" class="p-4 text-center text-slate-400 text-sm">No pending payments found.</td>
                </tr>
                @endforelse
            </tbody>
        </table>
