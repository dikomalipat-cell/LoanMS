...
@section('content')
<div class="mb-6">
    <h1 class="text-2xl font-bold text-white">Rejected Applications</h1>
    <p class="text-slate-300 mt-1">Loan applications that did not meet the requirements.</p>
</div>
        ...
        <table class="w-full text-left border-collapse">
            <thead>
                <tr class="bg-primary-dark border-b border-slate-700">
                    ...
                    <th class="p-4 text-xs font-semibold text-slate-400 uppercase tracking-wider">Reason</th>
            ...
            <tbody>
                ...
                <tr class="border-b border-gray-50 hover:bg-primary-dark transition">
                    ...
                    <td class="p-4 text-sm text-slate-400">{{ $application->rejection_reason ?? 'No reason provided' }}</td>
                    <td class="p-4"><span class="bg-red-100 text-red-700 px-2 py-1 rounded-full text-xs font-semibold">Rejected</span></td>
                </tr>
                @empty
                <tr>
                    <td colspan="5" class="p-4 text-center text-slate-400 text-sm">No rejected applications found.</td>
                </tr>
                @endforelse
            </tbody>
        </table>
