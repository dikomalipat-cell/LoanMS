...
<div class="mb-6">
    ...
    <p class="text-gray-600 mt-1">Loan applications awaiting initial review.</p>
</div>
        ...
        <table class="w-full text-left border-collapse">
            <thead>
                <tr class="bg-gray-50 border-b border-gray-100">
                    ...
                    <th class="p-4 text-xs font-semibold text-gray-500 uppercase tracking-wider">Date Filed</th>
            ...
            <tbody>
                ...
                <tr class="border-b border-gray-50 hover:bg-gray-50 transition">
                    ...
                    <td class="p-4"><span class="bg-yellow-100 text-yellow-700 px-2 py-1 rounded-full text-xs font-semibold">Pending</span></td>
                    <td class="p-4 text-right">
                        <button class="text-blue-500 hover:text-blue-700 mr-2" title="Review"><i class="fas fa-eye"></i></button>
                        <button class="text-green-500 hover:text-green-700 mr-2" title="Approve"><i class="fas fa-check"></i></button>
                        <button class="text-red-500 hover:text-red-700" title="Reject"><i class="fas fa-times"></i></button>
                    </td>
                </tr>
                @empty
                <tr>
                    <td colspan="6" class="p-4 text-center text-gray-500 text-sm">No pending applications found.</td>
                </tr>
                @endforelse
            </tbody>
        </table>
