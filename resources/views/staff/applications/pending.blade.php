...
<div class="mb-6">
    ...
    <p class="text-slate-300 mt-1">Loan applications awaiting initial review.</p>
</div>
            ...
            <tbody>
                ...
                <tr class="border-b border-gray-50 hover:bg-primary-dark transition">
                    ...
                    <td class="p-4 text-right">
                        ...
                        <button class="text-green-500 hover:text-gold mr-2" title="Approve"><i class="fas fa-check"></i></button>
                        <button class="text-red-500 hover:text-red-700" title="Reject"><i class="fas fa-times"></i></button>
                    </td>
                </tr>
                @empty
                <tr>
                    <td colspan="6" class="p-4 text-center text-slate-400 text-sm">No pending applications found.</td>
                </tr>
                @endforelse
            </tbody>
        </table>
