...
<div class="mb-6 flex justify-between items-end">
    ...
    <div class="text-sm text-gray-500 font-medium bg-white px-4 py-2 rounded-lg border border-gray-200 shadow-sm">
...
@if($role === 'admin')
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        <!-- Stat Card 1 -->
        <div class="bg-white rounded-xl p-6 border border-gray-100 shadow-sm flex items-center gap-4 hover:shadow-md transition-shadow">
            ...
            <div>
                ...
                <h3 class="text-2xl font-bold text-gray-800">{{ number_format($stats['total_borrowers']) }}</h3>
            </div>
        </div>
        <!-- Stat Card 2 -->
        <div class="bg-white rounded-xl p-6 border border-gray-100 shadow-sm flex items-center gap-4 hover:shadow-md transition-shadow">
            ...
            <div>
                ...
                <h3 class="text-2xl font-bold text-gray-800">{{ number_format($stats['active_loans']) }}</h3>
            </div>
        </div>
        <!-- Stat Card 3 -->
        <div class="bg-white rounded-xl p-6 border border-gray-100 shadow-sm flex items-center gap-4 hover:shadow-md transition-shadow">
            ...
            <div>
                <p class="text-sm font-medium text-gray-500">Overdue Accounts</p>
                <h3 class="text-2xl font-bold text-gray-800">{{ number_format($stats['overdue_followups']) }}</h3>
            </div>
        </div>
        <!-- Stat Card 4 -->
        <div class="bg-white rounded-xl p-6 border border-gray-100 shadow-sm flex items-center gap-4 hover:shadow-md transition-shadow">
            ...
            <div>
                ...
                <h3 class="text-2xl font-bold text-gray-800">₱ {{ number_format($stats['total_disbursed'] >= 1000000 ? $stats['total_disbursed']/1000000 : $stats['total_disbursed'], 1) }}{{ $stats['total_disbursed'] >= 1000000 ? 'M' : '' }}</h3>
            </div>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div class="bg-white p-6 rounded-xl border border-gray-100 shadow-sm">
            ...
            <div class="grid grid-cols-2 gap-4">
                <a href="{{ route('loan.index') }}" class="p-4 border border-gray-200 rounded-lg hover:border-green-500 hover:bg-green-50 transition text-center group">
                ...
                <a href="{{ route('banks.index') }}" class="p-4 border border-gray-200 rounded-lg hover:border-green-500 hover:bg-green-50 transition text-center group">
        ...
        <div class="bg-gradient-to-br from-green-700 to-green-900 p-6 rounded-xl shadow-sm text-white flex flex-col justify-center">
            ...
            <p class="text-green-100 mb-4 text-sm">All systems are running smoothly. Database backups are up to date.</p>
            <a href="{{ route('settings.index') }}" class="bg-white text-green-800 px-4 py-2 rounded-lg text-sm font-medium self-start hover:bg-gray-100 transition shadow-sm">
                Go to Settings
            </a>
        </div>
    </div>
...
@elseif($role === 'staff')
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        ...
        <div class="bg-white rounded-xl p-6 border border-gray-100 shadow-sm flex items-center gap-4 hover:shadow-md transition-shadow">
            ...
            <div>
                ...
                <h3 class="text-2xl font-bold text-gray-800">{{ number_format($stats['pending_apps']) }}</h3>
            </div>
        </div>
        <!-- Stat Card 2 -->
        <div class="bg-white rounded-xl p-6 border border-gray-100 shadow-sm flex items-center gap-4 hover:shadow-md transition-shadow">
            ...
            <div>
                <p class="text-sm font-medium text-gray-500">Payments to Verify</p>
                <h3 class="text-2xl font-bold text-gray-800">{{ number_format($stats['payments_to_verify']) }}</h3>
            </div>
        </div>
        <!-- Stat Card 3 -->
        <div class="bg-white rounded-xl p-6 border border-gray-100 shadow-sm flex items-center gap-4 hover:shadow-md transition-shadow">
            ...
            <div>
                ...
                <h3 class="text-2xl font-bold text-gray-800">{{ number_format($stats['due_today']) }}</h3>
            </div>
        </div>
        <!-- Stat Card 4 -->
        <div class="bg-white rounded-xl p-6 border border-gray-100 shadow-sm flex items-center gap-4 hover:shadow-md transition-shadow">
    ...
    <div class="bg-white p-6 rounded-xl border border-gray-100 shadow-sm mb-6">
        <h3 class="text-lg font-bold text-gray-800 mb-4">Task Shortcuts</h3>
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
            <a href="{{ route('staff.applications.pending') }}" class="p-4 border border-gray-200 rounded-lg hover:border-green-500 hover:bg-green-50 transition text-center group">
            ...
            <a href="{{ route('staff.payments.tracking') }}" class="p-4 border border-gray-200 rounded-lg hover:border-green-500 hover:bg-green-50 transition text-center group">
            ...
            <a href="{{ route('staff.borrowers.all') }}" class="p-4 border border-gray-200 rounded-lg hover:border-green-500 hover:bg-green-50 transition text-center group">
            ...
            <a href="{{ route('staff.schedule.overdue') }}" class="p-4 border border-gray-200 rounded-lg hover:border-green-500 hover:bg-green-50 transition text-center group">
...
@else
    ...
    <div x-data="{ showApplyModal: false }">
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
            ...
            <div class="lg:col-span-2 bg-gradient-to-r from-green-800 to-green-600 rounded-xl p-6 shadow-md text-white relative overflow-hidden">
                <div class="absolute right-0 top-0 opacity-10">
                    <i class="fas fa-wallet text-[150px] -mt-10 -mr-10"></i>
                </div>
                <div class="relative z-10">
                    <p class="text-green-100 text-sm font-medium mb-1 uppercase tracking-wider">Active Loan Balance</p>
                    <h2 class="text-4xl font-bold mb-4">₱ {{ number_format($client?->balance ?? 0, 2) }}</h2>
                    
                    <div class="flex flex-wrap gap-6 mt-6">
                        <div>
                            <p class="text-xs text-green-200 mb-1">Next Payment Due</p>
                            <p class="font-semibold text-lg">₱ {{ number_format(($client?->loan_amount ?? 0) / 6, 2) }}</p>
                        </div>
                        <div>
                            <p class="text-xs text-green-200 mb-1">Due Date</p>
                    ...
                    <div class="mt-6">
                        @if($client && $client->balance > 0)
                            <a href="{{ route('user.payments.make') }}" class="inline-block bg-white text-green-700 font-bold py-2 px-6 rounded-full shadow-sm hover:shadow-md hover:bg-gray-50 transition">
                                Pay Now <i class="fas fa-arrow-right ml-2"></i>
                            </a>
                        @else
                            <button @click="showApplyModal = true" class="inline-block bg-white text-green-700 font-bold py-2 px-6 rounded-full shadow-sm hover:shadow-md hover:bg-gray-50 transition">
            ...
            <div class="flex flex-col gap-6">
                ...
                <div class="bg-white p-5 rounded-xl border border-gray-100 shadow-sm flex items-start gap-4">
                    ...
                    <div>
                        @if($client && $client->balance > 0)
                            <h3 class="font-bold text-gray-800 text-sm mb-1">Loan Status</h3>
                            <p class="text-xs text-gray-500 mb-2">You currently have an active loan. You cannot apply for a new one until this is fully paid.</p>
                            <a href="{{ route('user.loans.active') }}" class="text-blue-600 hover:text-blue-800 text-xs font-semibold">View Details &rarr;</a>
                        @else
                            <h3 class="font-bold text-gray-800 text-sm mb-1">Ready to Apply?</h3>
                            <p class="text-xs text-gray-500 mb-2">You are eligible to apply for a new loan. Click the button below to get started.</p>
                ...
                <div class="bg-white p-5 rounded-xl border border-gray-100 shadow-sm flex items-start gap-4">
                    ...
                    <div>
                        <h3 class="font-bold text-gray-800 text-sm mb-1">Documents</h3>
                        <p class="text-xs text-gray-500 mb-2">All your submitted requirements are verified and up to date.</p>
                        <a href="{{ route('user.documents.submitted') }}" class="text-green-600 hover:text-green-800 text-xs font-semibold">View Files &rarr;</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
            <div class="flex justify-between items-center mb-4">
                ...
                <a href="{{ route('user.payments.history') }}" class="text-sm text-green-600 hover:text-green-800 font-medium">View All</a>
            </div>
            <div class="divide-y divide-gray-100">
                <div class="py-3 flex justify-between items-center">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <p class="text-sm font-medium text-gray-800">Monthly Amortization</p>
                            <p class="text-xs text-gray-500">Apr 15, 2026 • Bank Transfer</p>
                        </div>
                    </div>
                    <div class="text-right">
                        <p class="text-sm font-bold text-gray-800">- ₱ 5,000.00</p>
                        <p class="text-[10px] font-semibold text-green-600 uppercase">Verified</p>
                    </div>
                </div>
                <div class="py-3 flex justify-between items-center">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <p class="text-sm font-medium text-gray-800">Monthly Amortization</p>
                            <p class="text-xs text-gray-500">Mar 15, 2026 • GCash</p>
                        </div>
                    </div>
                    <div class="text-right">
                        <p class="text-sm font-bold text-gray-800">- ₱ 5,000.00</p>
                ...
                <div x-show="showApplyModal" 
                    ...
                    <div class="bg-white px-6 py-6 sm:p-8">
                        <div class="flex justify-between items-center mb-6">
                            <h3 class="text-xl font-bold text-gray-800">Apply for a Loan</h3>
                            <button @click="showApplyModal = false" class="text-gray-400 hover:text-gray-600 transition">
                        ...
                        <form action="{{ route('user.loans.store') }}" method="POST" class="space-y-4">
                            ...
                            <div class="pt-4 flex gap-3">
                                <button type="button" @click="showApplyModal = false" class="flex-1 px-4 py-3 border border-gray-200 text-gray-600 font-semibold rounded-xl hover:bg-gray-50 transition">
                                    Cancel
                                </button>
                                <button type="submit" class="flex-1 px-4 py-3 bg-green-600 text-white font-bold rounded-xl hover:bg-green-700 shadow-md hover:shadow-lg transform active:scale-95 transition-all">
                                    Submit
                                </button>
                            </div>
                        </form>
