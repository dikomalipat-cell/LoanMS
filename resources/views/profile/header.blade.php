<!-- DASHBOARD HEADER -->
<header
    class="bg-white border-b border-gray-200 px-4 md:px-6 py-3 flex items-center justify-between sticky top-0 z-10 shadow-sm">
    ...
    <div class="flex items-center gap-3">
        ...
        <div class="hidden sm:flex items-center gap-2 text-sm text-gray-500">
            ...
            <span class="text-gray-300">·</span>
            <span
                class="text-xs font-semibold text-gray-500">{{ (bool) (Auth::user()?->is_admin ?? false) ? 'Admin' : 'User' }}</span>
        </div>
    </div>
    ...
    <div class="flex items-center gap-2 md:gap-3">
        ...
        <div class="relative" x-data="{ open: false }" @click.away="open = false">
            <button @click="open = !open"
                ...
                <div
                    class="w-8 h-8 rounded-full bg-gradient-to-br from-green-400 to-green-600 flex items-center justify-center flex-shrink-0">
